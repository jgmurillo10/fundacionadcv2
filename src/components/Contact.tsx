...
export default function Contact() {
  ...
  function handleSubmit(e: FormEvent) {
    ...
    const lines = [
      `*Contacto web \u2013 Fundaci\u00f3n ADC*`,
      ``,
      `*Nombre:* ${form.nombre}`,
      form.organizacion ? `*Organizaci\u00f3n:* ${form.organizacion}` : "",
      `*Correo:* ${form.correo}`,
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={inputClasses}
                placeholder="Nombre de tu organizaci&oacute;n"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Cu&eacute;ntanos sobre tu proyecto o iniciativa"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-green-700 text-white font-semibold rounded-xl py-4 hover:bg-green-800 transition shadow-lg cursor-pointer inline-flex items-center justify-center gap-2"
            >
